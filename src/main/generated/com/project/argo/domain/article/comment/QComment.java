...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 911736833L;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.article = inits.isInitialized("article") ? new com.project.argo.domain.article.QArticle(forProperty("article"), inits.get("article")) : null;
